...
public class AuthorizeAspect {
    ...
    public Object isUserHavePermission(ProceedingJoinPoint joinPoint) throws Throwable {
        Authorize authorize = ((MethodSignature) joinPoint
                .getSignature()).getMethod().getAnnotation(Authorize.class);

        HttpServletRequest request = (HttpServletRequest) Arrays
                .stream(joinPoint.getArgs()).map(arg -> arg instanceof HttpServletRequest ? arg : null)
